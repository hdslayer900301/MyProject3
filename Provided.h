...
struct GeoCoord
{
    GeoCoord(FString lat, FString lon)
...
public:
    ...
    NavSegment(FString direction, FString streetName, double distance, const GeoSegment& gs)
    ...
    NavSegment(FString direction, FString streetName)
